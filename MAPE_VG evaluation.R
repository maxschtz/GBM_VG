...
write.csv(week_1_MAPEs, file = "VG_week_1_MAPEs.csv", row.names = FALSE)
...
write.csv(week_2_MAPEs, file = "VG_week_2_MAPEs.csv", row.names = FALSE)
...
write.csv(month_1_MAPEs, file = "VG_month_1_MAPEs.csv", row.names = FALSE)
...
write.csv(month_6_MAPEs, file = "VG_month_6_MAPEs.csv", row.names = FALSE)
