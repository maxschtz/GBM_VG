...
write.csv(week_1_MAEs, file = "GBM_week_1_MAEs.csv", row.names = FALSE)
...
write.csv(week_2_MAEs, file = "GBM_week_2_MAEs.csv", row.names = FALSE)
...
write.csv(month_1_MAEs, file = "GBM_month_1_MAEs.csv", row.names = FALSE)
...
write.csv(month_6_MAEs, file = "GBM_month_6_MAEs.csv", row.names = FALSE)
